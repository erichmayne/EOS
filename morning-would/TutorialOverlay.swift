...
let appTutorialSteps: [TutorialStep] = [
    ...
    TutorialStep(targetId: "goals-card",
                 ...
                 message: "This card tracks your pushups and runs. Green means you've hit your target for the day.",
                 icon: "target"),
    TutorialStep(targetId: "timer",
                 title: "Beat the Clock",
                 message: "Complete your goals before the deadline. Miss it, and your stakes are on the line.",
                 icon: "clock"),
    TutorialStep(targetId: "pushup-button",
                 title: "Count Your Pushups",
                 message: "Tap to start a pushup session. Your phone's camera tracks each rep automatically.",
                 icon: "figure.strengthtraining.traditional"),
    TutorialStep(targetId: "objective-button",
                 title: "Configure Your Goals",
                 message: "Set daily targets, choose between pushups and running, pick your schedule and deadline.",
                 icon: "gearshape"),
